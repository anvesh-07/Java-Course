...
public class Swapping {
  public static void main(String[] args) {
    ...
    System.out.println("Before swapping: a = " + a + ", b = " + b); // Prints the initial values of 'a' and 'b' to the
                                                                    // console.
    ...
    b = temp; // Assigns the value stored in 'temp' (the original value of 'a') to 'b'. Now
              // 'b' holds 10.
    System.out.println("After swapping: a = " + a + ", b = " + b); // Prints the values of 'a' and 'b' after the first
                                                                   // swap.
    ...
    // Step 1: a = a ^ b;
    // This line performs a bitwise XOR operation between 'a' and 'b' and stores the
    // result back into 'a'.
    // The new value of 'a' now holds the combined, unique bit information from both
    // original numbers.
    //
    // 0001 0100 (a = 20)
    // ^ 0000 1010 (b = 10)
    ...
    // Step 2: b = b ^ a;
    // Now, we XOR the original value of 'b' with the new value of 'a' (which is a ^
    // b).
    // The logic is: b = original_b ^ (original_a ^ original_b).
    // Because of XOR's properties, the two 'original_b' terms cancel out, leaving
    // 'original_a'.
    //
    // 0000 1010 (b = 10)
    // ^ 0001 1110 (a = 30)
    ...
    // Step 3: a = a ^ b;
    // Finally, we XOR the current 'a' (which is still a ^ b) with the new 'b'
    // (which is the original 'a').
    // The logic is: a = (original_a ^ original_b) ^ new_b.
    // Since new_b is original_a, this becomes: a = (original_a ^ original_b) ^
    // original_a.
